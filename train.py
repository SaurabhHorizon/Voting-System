...
# total count for photo samples
count_max = 50
# resize or rescale the image
size = 4
# harcascade classifier to detect face read about open cv cascade classifer 
fn_haar = 'haarcascade_frontalface_default.xml'
# directory tosave captured face (dir name is face anme)
fn_dir = 'att_faces'
#parse argument 
try:
    fn_name = sys.argv[1]
...
#open default camera  o f laptop or system
...
while count < count_max:
    ...
    if faces:
        ...
        # resize the image of face to save in directory 
